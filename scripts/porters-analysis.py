...
algorithm to minimize each cost term from the objective function, providing a 
vectorized solution.

Disclaimer: 
This is meant for educational purposes only and isn't intended to cause
harm to business simulation software. Users use it at their own risk. By using this 
script, you are agreeing to claim all responsibility for mis-use.

The error rate for predicting sales volume is +/- 5%
...
class Model:
    ...
    def fit(self):
        ...
        df = pd.read_csv('C:/Users/Dan/Downloads/BUSN450 FEATURES - cv_predict (12).csv')
